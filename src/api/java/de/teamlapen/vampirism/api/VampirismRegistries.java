...
public class VampirismRegistries {
    ...
    public static final Supplier<IForgeRegistry<Codec<? extends Converter>>> ENTITY_CONVERTER = Suppliers.memoize(() -> RegistryManager.ACTIVE.getRegistry(ENTITY_CONVERTER_ID));
