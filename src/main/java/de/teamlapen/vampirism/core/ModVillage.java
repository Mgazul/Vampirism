...
public class ModVillage {
    ...
    public static final RegistryObject<PoiType> VULNERABLE_ROOTS = POI_TYPES.register("vulnerable_roots", () -> new PoiType(getAllStates(ModBlocks.VULNERABLE_CURSED_ROOTED_DIRT.get()), 0, 1));
